    ...
    <Card containerStyle={[tw(`${fullWidth ? 'rounded-none m-0' : "rounded-lg"} my-2`), 
    {
      ...
      <View style={fullWidth && { height: "100%"}} >
        ...
        <View style={tw("items-start p-5 -mt-3")}>
            ...
            <Text style={tw('text-white text-centeer text-lg font-bold')}>Expected Delivery: {new Date(order.createdAt).toLocaleDateString()}</Text>
            <Divider color="white" />
            </View>

        <View style={tw("mx-auto pb-5")}>
            <Text style={tw("text-center text-white font-bold mt-5")}>Address</Text>
